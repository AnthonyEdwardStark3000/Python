# Game to compare and find the result
import random
...
def game(cont):
    ...
    if choice_number1 == choice_number2:
        choice_number2 += 1

    print(f"Welcome to {logo}")

    player_A = data[choice_number1]
    print(
        f"Compare A:{player_A['name']},a {player_A['description']} from {player_A['country']}  ")
    print(vs)
    player_B = data[choice_number2]
    print(
        f"\n\tCompare B:{player_B['name']},a {player_B['description']} from {player_B['country']}  ")
